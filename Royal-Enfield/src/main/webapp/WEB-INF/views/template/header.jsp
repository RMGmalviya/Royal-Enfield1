        ...
        <nav class="navbar navbar-light"style="background-color:#e3f2f8"> 
            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<c:url value="/" /> ">Royal-Enfield</a>
                </div>
                 <div align="right" class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" style="display:block">

        <img src="${pageContext.servletContext.contextPath}/resources/images/logo.png" width="70" height="70" align=left>
    
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <li><a href="<c:url value="/" /> "><span class="glyphicon glyphicon-home"></span>  Home</a></li>
                        <c:if test="${pageContext.request.userPrincipal.name == 'my'}">
                        	<li><a href="<c:url value="/admin/productInventory" />">Products</a></li>
                        </c:if>
                        <c:if test="${pageContext.request.userPrincipal.name != 'my'}">
